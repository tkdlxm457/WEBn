...
exports.page = function(request, response){
    ...
    db.query(`SELECT * FROM topic`, function(err, topics){
        ...
        db.query(`SELECT * FROM topic LEFR JOIN author ON topic.author.id = author.id WHERE topic.id = ?`,[queryData.id], function(err2, topic){
          if(err2){
            throw err2;
          }
...
exports.create_process = function(request, response){
    ...
    request.on('end', function(){
        ...
        db.query(`
        INSERT INTO topic (title, description, created, aythor, author_id) 
        VALUES(?, ?, NOW(), ?)`,
